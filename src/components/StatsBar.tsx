...
export const StatsBar: React.FC<StatsBarProps> = ({ onBookConsultation }) => {
  return (
    <section className="commanSection sectionOne noSpace">
        ...
        <div className="boxSuccessRate">
          <div className="column">
            <div className="iconRate">
              <img src="/assets/img/talent1.svg" alt="Success Rate" />
            </div>
          ...
          <div className="column">
            <div className="iconRate">
              <img src="/assets/img/family-dress1.svg" alt="Happy Families" />
            </div>
            <div className="contentRate">
          ...
          <div className="column">
            <div className="iconRate">
              <img src="/assets/img/thumbs-up-trust1.svg" alt="Years of Trust" />
            </div>
            <div className="contentRate">
      ...
      {/* Styled toggle helper to sync with existing style.css banner media queries */}
      <style>{`
