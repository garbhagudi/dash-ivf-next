        ...
        <Dialog as='div' className='relative z-10' onClose={closeModal}>
          ...
          <div className='fixed inset-0 overscroll-y-contain'>
            <div className='mx-auto flex min-h-full max-w-lg items-center justify-center text-center'>
              ...
              >
                <Dialog.Panel className='-mt-5 w-full max-w-lg transform cursor-pointer overflow-hidden rounded bg-brandPurple align-middle opacity-95 shadow-xl transition-all'>
                  <div
