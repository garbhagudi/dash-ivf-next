export const doctors = [
  {
    ...
    bio: (
      <div>
        <div class="w-full lg:w-9/12 mx-auto flex justify-start">
          <div class="mb-4 text-gray-800 prose">
            <div class="text-center text-xl text-brandDark font-semibold my-4 font-heading">
              <p>
            ...
            <div class="text-center text-lg text-brandDark font-semibold mt-3 font-heading">
              <p>
