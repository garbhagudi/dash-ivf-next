  ...
  return (
    <section className="commanSection sectionSevan">
      <div className="container">
        ...
        <h2 className="mainHeading">See What Our <b>Patients</b> Say</h2>
        <p className="subText">
          <b>Thousands of couples</b> have found their path to parenthood with GarbhaGudi. Here's what some of them have to say.
        </p>
            ...
            {testimonialsList.map((item, idx) => (
              <div key={idx} className="boxTestimonials">
                <div className="innerTestimonials">
                  <div className="imgStar"><img src="/assets/img/start.svg" alt="Rating Stars" /></div>
                  <p>{item.feedback}</p>
          ...
          <CustomCarousel desktopItems={3} mobileItems={1} gap={20}>
            {videoData.map((video, idx) => (
              <div key={idx} className="item">
                <a href="#" onClick={(e) => { e.preventDefault(); onPlayVideo(video.url); }} style={{ cursor: 'pointer' }}>
