import Features from 'sections/lp-catalyst/features';

const OtherServices = () => {
  return (
    <div className='pt-10 md:pt-8 pb-16 bg-white'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='lg:text-center'>
          <p className='mt-2 text-xl leading-8 font-bold font-heading text-gray-700 underline sm:text-2xl text-center'>
            What sets GarbhaGudi apart from the rest?
          </p>
        </div>
        <div className='mt-10 text-center'>
          GarbhaGudi IVF Centre has earned the prestigious title of{' '}
          <h1>the Best IVF and Fertility Center in Bangalore,</h1> as recognized
          by numerous esteemed organizations.
        </div>
        <div className='max-w-4xl mx-auto pb-12'>
          <div className='max-w-3xl mx-auto text-center font-bold py-6 md:py-10'>
            <h2 className='text-3xl md:text-4xl mb-4'>
              ...
              , GarbhaGudi has been the trusted choice of couples{' '}
              <span className='bg-clip-text text-transparent bg-gradient-to-r from-brandPink to-brandPurpleDark'>
                more than 10,000{' '}
              </span>
              worldwide.
