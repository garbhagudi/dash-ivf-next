  ...
  return (
    <div className="mx-auto max-w-7xl px-3 sm:px-0">
      ...
      <div className="max-w-4xl text-center mx-auto py-8">
        ...
        infertility cases; the problem is male infertility and is most often due
        to problems with his sperm production or with sperm delivery.
        Thankfully, there are solutions to treat male infertility.
      </div>
    </div>
  );
};
