...
import LandingNextHeroVideo from 'sections/landing-next/landing-next-hero-video';
...
export default function LandingNextHero() {
  return (
    <section className='relative overflow-hidden bg-gradient-to-br from-pink-300 to-purple-100'>
      ...
      <div className='relative mx-auto flex max-w-6xl flex-col px-4 py-8 sm:px-5 sm:py-9 lg:grid lg:grid-cols-2 lg:items-start lg:gap-8 lg:py-10'>
        {/*
          Mobile: video first so the real <img fetchpriority="high"> is in the first viewport
          (LCP). Desktop: copy column first (unchanged reading order via lg:order).
        */}
        <div className='order-2 mt-8 w-full max-w-lg self-center lg:order-1 lg:mt-0 lg:max-w-none lg:justify-self-start'>
          ...
          <div className='mt-5'>
            ...
            >
              ...
              <HiArrowRight size={16} className='shrink-0' aria-hidden />
            </a>
          </div>
        </div>
