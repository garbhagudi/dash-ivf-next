      ...
      <div className='relative mx-auto mt-10 max-w-7xl px-4 sm:px-6'>
        <div className='py-4 md:py-6'>
          ...
          <div className='flex flex-wrap items-center justify-center gap-5'>
            {Data.map((items) => (
              <div
                className='relative flex flex-col items-center rounded-lg bg-white p-3 transition-all duration-300 hover:-translate-x-2 hover:-translate-y-2 hover:border-0 hover:shadow-2xl dark:bg-gray-700'
                key={items.id}
              >
                <Image
                  src={items.img}
