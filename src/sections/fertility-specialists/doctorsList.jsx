...
const DoctorsList = () => {
  const doctors = [
    ...
    },
    {
      ...
      content: `Dr. Manasa is a dedicated and compassionate fertility specialist in Davanagere with experience in obstetrics, gynecology, and reproductive medicine. With a strong academic background and specialized training in fertility care, Dr. Manasa has helped couples overcome infertility challenges and achieve successful pregnancies. Known for a patient-centered and evidence-based approach, she offers the highest standard of IVF care using cutting-edge technology. Fluent in Kannada, English, Hindi, and Telugu, Dr. Manasa is able to connect deeply with patients from diverse linguistic backgrounds.`,
    },
    {
      category: 'fertilitySpecialist',
      designation: 'Fertility Specialist',
      ...
      content: `DDr. Radha Puchalapalli is a compassionate and experienced gynecologist and fertility specialist with a strong foundation in reproductive medicine. With over 6 years of clinical experience across rural development and private hospital settings, she has dedicated her career to supporting women and couples in their journey towards parenthood. Her multilingual ability (Telugu, Kannada, Hindi, Tamil, and English) enables her to connect deeply with patients from diverse backgrounds.`,
    },
    {
