  ...
  return (
    <>
      ...
      >
        ...
        <form
          className="flex w-full mx-auto max-w-sm"
        ...
        >
          ...
          <input
            ...
            style={{ display: "none" }}
            name="returnURL"
            value="https&#x3a;&#x2f;&#x2f;garbhagudi-ivf.com&#x2f;contact&#x2f;thank-you"
          />
          <input
            type="text"
            style={{ display: "none" }}
          ...
          <input
            ...
            name="LDTuvid"
          ></input>
          <div className="w-full max-w-2xl mx-auto px-5 py-10 m-auto bg-transparent rounded-lg">
